  ...
  return (
    <div className='flex flex-col sm:flex-row sm:items-center mt-12 sm:justify-between'>
        ...
        <div>
            ...
            <select value={filterTag} onChange={updateTag} className='border-gray-500 border-2 rounded-lg p-2 min-w-[150px]'>
        ...
        <div>
            ...
            <select value={filterStatus} onChange={updateStatus} className='border-gray-500 border-2 rounded-lg p-2 min-w-[150px]'>
                <option value="all">All</option>
